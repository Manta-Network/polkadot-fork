...
impl<BlockNumber: Default + From<u32>> Default for HostConfiguration<BlockNumber> {
	fn default() -> Self {
		Self {
			...
			chain_availability_period: 10u32.into(),
			thread_availability_period: 10u32.into(),
			no_show_slots: 1u32.into(),
			validation_upgrade_cooldown: Default::default(),
			validation_upgrade_delay: 2u32.into(),
			code_retention_period: 28800u32.into(),
			max_code_size: Default::default(),
			max_pov_size: Default::default(),
			max_head_data_size: 20480u32.into(),
			parathread_cores: Default::default(),
			parathread_retries: Default::default(),
			scheduling_lookahead: 1u32.into(),
			max_validators_per_core: 5u32.into(),
			max_validators: 500u32.into(),
			dispute_period: 6,
			dispute_post_conclusion_acceptance_period: 600u32.into(),
			n_delay_tranches: 89u32.into(),
			zeroth_delay_tranche_width: Default::default(),
			needed_approvals: 30u32.into(),
			relay_vrf_modulo_samples: 6u32.into(),
			max_upward_queue_count: 699050u32.into(),
			max_upward_queue_size: 4194304u32.into(),
			max_downward_message_size: 51200u32.into(),
			max_upward_message_size: 65531u32.into(),
			max_upward_message_num_per_candidate: 128u32.into(),
			hrmp_sender_deposit: Default::default(),
			hrmp_recipient_deposit: Default::default(),
			hrmp_channel_max_capacity: 1000u32.into(),
			hrmp_channel_max_total_size: 102400u32.into(),
			hrmp_max_parachain_inbound_channels: 30u32.into(),
			hrmp_max_parathread_inbound_channels: 0u32.into(),
			hrmp_channel_max_message_size: 102400u32.into(),
			hrmp_max_parachain_outbound_channels: 30u32.into(),
			hrmp_max_parathread_outbound_channels: 0u32.into(),
			hrmp_max_message_num_per_candidate: 10u32.into(),
